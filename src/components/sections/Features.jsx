...
const features = [
  ...
  },
  {
    ...
    description:
      "Posts that sound like you, not a robot — crafted for engagement, not just grammar.",
    icon: PenTool,
  },
  {
  ...
  },
  {
    ...
    description:
      "Context-aware enhancers that boost reach without feeling forced.",
    icon: Hash,
  },
  {
    title: "Platform-Tailored Output",
    description:
      "Each post is fine-tuned for its platform — format, tone, and style aligned.",
    icon: Monitor,
  },
  {
    title: "Fast, Frictionless Output",
    description:
      "Under 2 seconds. Every time. No delays. Just copy, paste, and publish — effortlessly.",
    icon: Zap,
  },
];
        ...
        >
          {features.map(({ title, description, icon: Icon }) => (
            <motion.div
              ...
              className="p-6 text-left rounded-2xl bg-secondary border border-border shadow-lg hover:shadow-xl hover:shadow-primary/20 hover:border-primary/30"
            >
