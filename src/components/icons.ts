...
// These functions return JSX.Element and take no props to avoid parsing issues.
...
// Type for icons that take no props (like our simplified custom ones)
...
const Icons = {
  ...
  chevronDown: ChevronsUpDown, // Assuming this is ChevronsUpDown from lucide
  circle: Circle,
  close: X,
  copy: Copy,
  ...
  info: Info,
  instagram: InstagramIconFC as StaticIconComponent,
  layers: Layers3,
  light: Sun, // Assuming this is Sun from lucide for light mode toggle
  lightbulb: Lightbulb,
  linkedin: Linkedin,
  ...
  // moon: Moon, // For dark mode toggle, if needed
  plus: Plus,
  ...
  smile: Smile,
  sparkles: Sparkles,
  spinner: Loader2, // Often used interchangeably with loader
  tag: Tag,
  tiktok: TikTokIconFC as StaticIconComponent,
  trash: Trash,
  twitter: Twitter,
  upload: UploadCloud,
  user: User,
